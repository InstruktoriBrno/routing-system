...
class ScoreE2ETest extends EndToEndTest
{
    public function testTeamScore(): void
    {
        ...
        $request = $this->createRequestWithBody('POST', '/v1/game/round/4/router/B',
            <<<'JSON'
            {
        ...
        $request = $this->createRequestWithBody('POST', '/v1/game/round/4/router/D',
            <<<'JSON'
            {
        ...
        $request = $this->createRequestWithBody('POST', '/v1/game/round/4/router/J',
            <<<'JSON'
            {
        ...
        $request = $this->createRequestWithBody('POST', '/v1/game/round/4/team/A',
            <<<'JSON'
            {
                "score": 10,
        ...
        $request = $this->createRequestWithBody('POST', '/v1/game/round/4/team/B',
            <<<'JSON'
            {
                "score": 4,
                "reason": "malfunctioning router"
