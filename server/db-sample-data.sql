    ...
    ('Tutorial', FALSE, $$
        {
            ...
            "packets": {
                ...
                "010": { "type": "tcp", "releaseTime": 60, "source": "A", "destination": "B", "points": 10 },
                "011": { "type": "tcp", "releaseTime": 30, "source": "A", "destination": "B", "points": 10 },
                "012": { "type": "tcp", "releaseTime": 90, "source": "A", "destination": "B", "points": 10 },
                "020": { "type": "tcp", "releaseTime": 180, "source": "B", "destination": "A", "points": 10 },
                "030": { "type": "tcp", "releaseTime": 60, "source": "B", "destination": "C", "points": 10 }
            },
            "events": []
        }
    $$),
    ...
    ('Circle round', FALSE, $$
        {
            ...
            "packets": {
                ...
                "020": { "type": "tcp", "releaseTime": 60, "source": "A", "destination": "B", "points": 10 },
                "021": { "type": "tcp", "releaseTime": 120, "source": "A", "destination": "C", "points": 20 },
                "022": { "type": "tcp", "releaseTime": 180, "source": "A", "destination": "D", "points": 30 },
                "023": { "type": "tcp", "releaseTime": 240, "source": "A", "destination": "E", "points": 40 },
                "024": { "type": "tcp", "releaseTime": 300, "source": "A", "destination": "F", "points": 50 },
                "025": { "type": "tcp", "releaseTime": 360, "source": "A", "destination": "G", "points": 60 },
                "026": { "type": "tcp", "releaseTime": 420, "source": "A", "destination": "H", "points": 70 },
                "027": { "type": "tcp", "releaseTime": 480, "source": "A", "destination": "I", "points": 80 },
                "028": { "type": "tcp", "releaseTime": 540, "source": "A", "destination": "J", "points": 90 }
            },
            "events": [
